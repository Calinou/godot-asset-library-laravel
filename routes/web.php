...
Route::get('/asset/submit', 'AssetController@create')->name('asset.create')->middleware('auth');
Route::post('/asset', 'AssetController@store')->name('asset.store')->middleware('auth');
